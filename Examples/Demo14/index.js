...
AFRAME.registerComponent('selector', {
    init: function() {
        ...
        // <a-entity html="#my-interface" position="0 10 40"></a-entity>
        ...
        function startAnimation() {
            if (animationStatus == 'move-pause') {
                if (i == Math.ceil(packetParams.start/1000)) {
                    ...
                    // templateText = '<h1 style="padding: 0rem 1rem; font-size: 3rem; font-weight: 700;">' + packetParams.id + '</h1>'
...
function setNodes(nodes, nodeList, data) {
    for (var i = 1; i < nodes.length; i++) {
        ...
        // newText.setAttribute('look-at', "[camera]");
        // newText.setAttribute('scale', {x: 2/data.elementsScale, y: 2/data.elementsScale, z: 2/data.elementsScale});

        
        // const div = document.createElement("section");
        // htmlBody = `
        // <section style="display: inline-block; background: #CCCCCC; color: yellow; border-radius: 1em; padding: 1em; margin:0; accent-color: hotpink;" id="node-name"><h1 style="padding: 0rem 1rem; font-size: 3rem; font-weight: 700;" id="'+ newNode.name +'">' + newNode.name + '</h1></section>`;
        // div.innerHTML = htmlBody;

        // console.log(div)

        // var addressContainer = document.getElementById("cuerpo");
        // addressContainer.appendChild(htmlBody);
